    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-12 animate-fade-in">
      <div className="w-full max-w-lg rounded-3xl border border-border bg-surface p-8 sm:p-10 shadow-xl transition-all">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.25em] font-extrabold text-success">
              Security Center
            </p>
        ...
        <p className="mt-4 text-sm text-text-muted leading-relaxed">
          Paste the reset token generated from the forgot password portal and
        ...
        {success ? (
          <div className="mt-6 rounded-2xl border border-success/30 bg-success/10 p-6 text-center space-y-4 animate-scale-up">
            <CheckCircle2
              size={48}
              className="mx-auto text-success animate-bounce"
            />
            <h3 className="text-lg font-black text-text">
              Password Successfully Updated!
            </h3>
            <p className="text-xs text-text-muted leading-relaxed">
              Your account password has been reset. You can now sign in using
              your newly created credentials to access your shop workspace.
            </p>
            <div className="pt-2">
              <Link
                to="/login"
